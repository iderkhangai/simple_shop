		...
		<div class="card-body">
			<form action="" id="manage-settings">
				<div class="form-group">
					<label for="name" class="control-label">Сайтын нэр</label>
				...
				<center>
					<button class="btn btn-success  btn-block col-md-2">Хадгалах</button>
				</center>
			</form>
		</div>
	</div>
		...
		$('#manage-settings').submit(function(e) {
			...
			$.ajax({
				...
				success: function(resp) {
					if (resp == 1) {
						alert_toast('Амжилттай хадгалагдлаа.', 'success')
						setTimeout(function() {
							location.reload()
						}, 1000)
					}
