<div class="container-fluid">
	...
	<table class="table table-bordered">
		...
		<tfoot>
			<tr>
				<th colspan="2" class="text-right">Нийт</th>
	...
	<div class="text-center">
		<button class="btn btn-primary" id="confirm" type="button" onclick="confirm_order()">Хүлээн авсан</button>
	...
	function confirm_order() {
		...
		$.ajax({
			...
			success: function(resp) {
				if (resp == 1) {
					alert_toast("Захиалга баталгаажсан.")
					setTimeout(function() {
						location.reload()
					}, 1500)
				}
