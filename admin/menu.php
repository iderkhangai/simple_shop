					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label">Бараа нэр</label>
							...
							<div class="form-group">
								<div class="custom-control custom-switch">
									...
									<label class="custom-control-label" for="availability">Бараа нөөцөд байгаа эсэх</label>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="" class="control-label">Зураг</label>
						...
						<div class="card-footer">
							<div class="row">
								<div class="col-md-12">
									<button class="btn btn-sm btn-success col-sm-3 offset-md-3"><span class="fa fa-save"></span> Хадгалах</button>
									<button class="btn btn-sm btn-info col-sm-3" type="button" onclick="$('#manage-menu').get(0).reset()"> Цуцлах</button>
								</div>
							</div>
						</div>
					</div>
							...
							<table class="table table-bordered table-hover">
								<thead>
									<tr>
										...
										<th class="text-center">Зураг</th>
										<th class="text-center">Захиалга дэлгэрэнгүй</th>
										<th class="text-center">Үйлдлүүд</th>
									</tr>
								</thead>
								<tbody>
									<?php
									...
									?>
										<tr>
											...
											<td class="">
												<p>Нэр : <b><?php echo $row['name'] ?></b></p>
												<p>Ангилал : <b><?php echo $row['cat'] ?></b></p>
												<p>Тайлбар : <b class="truncate"><?php echo $row['description'] ?></b></p>
												<p>Үнэ : <b><?php echo "₮" . number_format($row['price'], 2) ?></b></p>
											</td>
											<td class="text-center">
												...
												<button class="btn btn-sm btn-danger delete_menu" type="button" data-id="<?php echo $row['id'] ?>">Устгах</button>
											</td>
										</tr>
									<?php endwhile; ?>
								</tbody>
