 ...
 <header class="masthead">
        ...
        <div class="container">
        	...
        	<div class="col-lg-8">
        		<div class="sticky">
	        		<div class="card">
	        			<div class="card-body">
	        				<div class="row">
		        				<div class="col-md-8"><b>Бараанууд</b></div>
		        				<div class="col-md-4 text-right"><b>Нийт</b></div>
	        				</div>
	        			</div>
	        		</div>
	        	</div>
	        		...
	        		<div class="card-body">
		        		<div class="row">
			        		...
			        		<div class="col-md-4">
			        			...
			        			<p class='truncate'> <b><small>Тайлбар :<?php echo $row['description'] ?></small></b></p>
			        			<p> <b><small>Нэгж үнэ :<?php echo number_format($row['price'],2) ?></small></b></p>
        	...
        	<div class="col-md-4">
        		<div class="sticky">
        			<div class="card">
        				<div class="card-body">
        					<p><large>Нийт төлөх</large></p>
        					<hr>
        					<p class="text-right"><b><?php echo number_format($total,2) ?></b></p>
        					<hr>
        					<div class="text-center">
        						<button class="btn btn-block btn-outline-dark" type="button" id="checkout">Үргэлжлүүлэх</button>
        					</div>
        				</div>
        			</div>
        		</div>
    ...
    <script>
        ...
        $('.view_prod').click(function(){
            uni_modal_right('Бараа','view_prod.php?id='+$(this).attr('data-id'))
        })
