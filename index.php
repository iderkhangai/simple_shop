...
<body id="page-top">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=home">Нүүр</a></li>
          <?php
          ...
          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=cart_list"><span> <span class="badge badge-danger item_count">0</span> <i class="fa fa-shopping-cart"></i> </span>Сагс</a></li>
          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=about">Бидний тухай</a></li>
          ...
          <?php else : ?>
            <li class="nav-item"><a class="nav-link js-scroll-trigger" href="javascript:void(0)" id="login_now">Нэвтрэх</a></li>
            <li class="nav-item"><a class="nav-link js-scroll-trigger" href="./admin">Админ хэсэг</a></li>
          <?php endif; ?>
        </ul>
      </div>
    </div>
  ...
  <footer class="bg-light py-5">
    <div class="container">
      <div class="small text-center text-muted">Бүх эрх хуулиар хамгаалагдсан © <?= date("Y") ?> - <?= $_SESSION['setting_name'] ?> | <a href="mailto:test@mail.com" target="_blank">барилга@gmail.com</a></div>
    </div>
  </footer>
